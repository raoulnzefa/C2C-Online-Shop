          ...
          <div class="nav-logo">
            <h1>
              <router-link to="/" title="商城官网"
                           style="background-image: url('http://127.0.0.1:8000/media/apple/icon.png')">
              </router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
              ...
              <el-input
                  ...
                  maxlength="100"
              ></el-input>
              <router-link to="/sale">销售商品</router-link>
            </div>
            ...
            <div class="nav-aside">
              ...
              <div class="user pr">
                  ...
                  <div class="nav-user-list">
                    <ul>
                      <li class="nav-user-avatar">
                        <div>
                          <span class="avatar" :style="{backgroundImage:'url('+head+')'}"></span>
                        </div>
                        <p class="name">{{ user }}</p>
                      </li>
                      ...
                      <li>
                        <router-link to="/myGoodsList">我的商品</router-link>
                      </li>

                      <li>
                        <router-link to="/mySale">我的销售</router-link>
                      </li>
                ...
                <div class="nav-user-wrapper pa" v-else>
                  <div class="nav-user-list">
                    <ul>
              ...
              >
                <router-link to="/cartList"></router-link>
                <span class="cart-num">
                ...
                <div class="nav-user-wrapper pa active" v-show="showCart">
                  <div class="nav-user-list">
                    <div class="full">
                                  ...
                                  <div class="item-desc">
                                    <div class="cart-cell">
                                      ...
                                      <h6>
                                        ...
                                        <span class="item-num">x {{ goods.num }}</span>
                                      </h6>
                                    </div>
                                  </div>
                                </a>
                                <div class="del-btn del" @click="CartDelete(goods.id)">删除</div>
                              </div>
                            </div>
                          </li>
                        </ul>
                      ...
                      <!-- 总件数 -->
                      <div class="nav-cart-total" v-if="login">
                        <p>
                          共
                        ...
                        <h6>
                          <el-button type="danger" @click="goToCart()">我的购物车</el-button>
                        </h6>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    getUsername() {
      ...
      this.head = getStore('head')
    },

    ...mapMutations(["SHOWCART", "CARTLIST"]),
    cartShowState(state) {
      this.SHOWCART({
        showCart: state
      })
    ...
    async CartList() {
      if (this.login) {
        const res = await this.$http.get("http://127.0.0.1:8000/api/CartList", {
          params: {
    ...
    async CartDelete(id) {
      if (this.login) {
        const res = await this.$http.post("http://127.0.0.1:8000/api/CartDelete", {
          token: getStore("token"),
          id: id
        });
        await this.CartList()
...
::v-deep .w-box .nav-list .el-input[data-v-4b2ab62f] {
  width: 500px;
}

::v-deep .w-box .nav-list a[data-v-4b2ab62f] {
  padding: 0;
}
  ...
  .user {
    ...
    > a {
      ...
      &:before {
        ...
        top: 0;
        @include wh(20px);
        background: url(../../public/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) -155px 0;
  ...
  .shop {
    ...
    > a {
      ...
      &:before {
        ...
        @include wh(30px, 100%);
        content: " ";
        background: url(../../public/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) 0 -22px;
        background-size: 240px 107px;
...
.nav-user-wrapper {
  ...
  .nav-user-list {
    ...
    &:before {
      position: absolute;
      content: " ";
      background: url(../../public/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) no-repeat -49px -43px;
      background-size: 240px 107px;
      @include wh(20px, 8px);
      top: -8px;
      margin-left: -10px;
